...
SIF=${1:?Usage: bash setup_env.sh /path/to/container.sif [requirements.txt] [output.sqsh]}

TRAIN_DIR=/scratch/project_465002364/Qomhra-2/ablations/train
REQ=${2:-${TRAIN_DIR}/requirements-lumi.txt}
SQSH=${3:-${TRAIN_DIR}/qomhra-env.sqsh}
VENV_DIR=${TRAIN_DIR}/qomhra-venv-${SLURM_JOB_ID:-manual}
